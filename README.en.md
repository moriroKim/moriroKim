...
Full-stack engineer who builds one product end to end, from the screen to the server to the deploy.

These days I build AI systems that run in the real world with [WIGTN](https://github.com/wigtn), a five-person AI dev and research crew.
...
My working rules are simple: never show what might be wrong, and never let automation touch what cannot be undone.

### Links

[Portfolio](https://portfolio-six-psi-ae0mjybkx1.vercel.app/en) · [wigtn.com](https://wigtn.com) · jinmo@wigtn.com
